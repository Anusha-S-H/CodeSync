...
function Editor() {
    ...
    useEffect(() => {
        ...
        // Try to get language extension with custom mapping
        const mappedLanguage = customMapping[language.toLowerCase()] || language.toLowerCase()
        const langExt = loadLanguage(mappedLanguage as LanguageName)
        
        if (langExt) {
            extensions.push(langExt)
        }
        // Silently continue without syntax highlighting if language not found
        // Editor will still work, just without syntax highlighting
